...
%% ----------------------------------------------------------------------------
%% BibLaTeX configuration (using biber backend)
%% Compilation: xelatex -> biber -> xelatex -> xelatex
%%
%% \addbibresource{filename.bib} loads the bibliography source file
%%   - Include the full filename with .bib extension
%% ----------------------------------------------------------------------------
...
and outline the paper structure \cite{zurekProbabilitiesEntanglementBorns2005}.
...
%% References
%% ----------------------------------------------------------------------------
%% \printbibliography prints the bibliography list
%%
%% Citation Commands:
%%   - \cite{key}      : Basic citation [1]
%%   - \parencite{key} : Parenthetical citation [1]
%%   - \textcite{key}  : Textual citation Author [1]
